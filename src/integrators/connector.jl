...
initTheta(this::Connector{T}) where {T} = zeros(T,0)
...
function apply(this::Connector{T},theta::Array{T},Y0::Array{T},doDerivative=true) where {T}
...
function Jmv(this::Connector{T},dtheta::Array{T},dY::Array{T},theta::Array{T},Y::Array{T},tmp=nothing) where {T}
...
function JTmv(this::Connector{T},Wdata::Array{T},W::Array{T},theta::Array{T},Y::Array{T},tmp=nothing) where {T}
